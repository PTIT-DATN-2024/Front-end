...
const paymentController = {
    createPayment: (req, res) => {
        try {
            ...
            let tmnCode = "F1I9CX1U";  // Mã TMN của bạn
            let secretKey = "LERNB4N4HGL1K59T6QP03Y2TR55VSITH";  // Khóa bí mật của bạn
            let vnpUrl = "https://sandbox.vnpayment.vn/paymentv2/vpcpay.html";  // Địa chỉ VNPay
            let returnUrl = "https://domainmerchant.vn/ReturnUrl";  // URL trả về sau khi thanh toán
            ...
            res.json({
                ...
                paymentUrl: vnpUrl  // URL thanh toán VNPay
            });
        } catch (error) {
            res.status(500).json({
