...
const TableProduct = (props) => {
    ...
    const [searchName, setSearchName] = useState("");  // New state for search keyword

    useEffect(() => {
        filterProducts();
    }, [countFilter, categoryFilter, sortType, searchName]);  // Include searchName as a dependency
            ...
            <div className="tableProduct">
                <div style={{ marginBottom: "20px" }} className="fillterContainer">
                    <input
                        ...
                        className="itemFilter nameSearch"
                    />
